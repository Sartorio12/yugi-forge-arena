...
-- Update get_tournament_banlist to return ban_master_duel for filtering
...
BEGIN
    ...
    GROUP BY 
        tbc.card_id, c.name, c.image_url_small, c.type, c.race, c.attribute, c.level, c.atk, c.def, c.ban_master_duel
    ORDER BY 
