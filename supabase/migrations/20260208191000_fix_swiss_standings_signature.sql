-- 1. Drop the function first to allow changing the return signature
DROP FUNCTION IF EXISTS public.get_tournament_swiss_standings(BIGINT);

-- 2. Recreate the function with the new game_difference column
