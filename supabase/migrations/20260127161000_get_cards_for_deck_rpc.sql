...
AS $$
BEGIN
    -- This function bypasses RLS on deck_cards/cards to ensure consistent loading
    -- Assuming the caller has already verified access to the deck itself via the 'decks' RLS
    RETURN QUERY
    SELECT 
        dc.card_api_id,
        dc.deck_section,
