-- 1. Drop the function to clear any stale definition and avoid signature conflicts
...
-- This is the critical step to fix the "Could not find function in schema cache" error
