...
import { Loader2, ArrowLeft, Trophy, Swords } from "lucide-react";
...
const TournamentBracketPage = ({ user, onLogout }: BracketPageProps) => {
  ...
  const PlayerSlot = ({ player, isWinner, isPlaceholder, align = "left" }: { player: any, isWinner: boolean, isPlaceholder?: boolean, align?: "left" | "right" }) => {
    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      ...
      <main className="mx-auto py-8 md:py-12 w-full">
        ...
        <div className="container mx-auto px-4 flex flex-col items-center mb-10 md:mb-16 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic text-white line-clamp-2">
             {tournament?.title}
          </h1>
