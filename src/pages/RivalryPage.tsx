                    ...
                    <div className="space-y-12 animate-in zoom-in-95 duration-700">
                        ...
                        <div className="flex items-center justify-center gap-12 md:gap-24 relative">
                            <div className="flex flex-col items-center">
                                <div className={`text-7xl md:text-9xl font-black ${p1Wins >= p2Wins ? 'text-white drop-shadow-[0_0_20px_rgba(147,51,234,0.5)]' : 'text-white/20'}`}>
                                    {p1Wins}
                                </div>
                            ...
                            <div className="flex flex-col items-center">
                                <div className={`text-7xl md:text-9xl font-black ${p2Wins >= p1Wins ? 'text-white drop-shadow-[0_0_20px_rgba(147,51,234,0.5)]' : 'text-white/20'}`}>
                                    {p2Wins}
                                </div>
                                <span className="text-[10px] font-bold uppercase tracking-widest mt-2 text-muted-foreground">SCORE</span>
                            </div>
                                    ...
                                    {history.map((match: any, idx: number) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-6">
                                                <div className="h-12 w-12 rounded-xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-primary/50 transition-colors">
                                                    <Trophy className={`h-6 w-6 ${match.winner_id === player1.id ? 'text-primary' : 'text-purple-400'}`} />
                                                </div>
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2 mt-1">
                                                        ...
                                                        {format(new Date(match.tournament_date), "dd/MM/yyyy")} • {match.round_name}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-4">
                                                <div className="hidden md:flex flex-col text-right">
                                                    ...
                                                    <span className="font-black italic">{match.winner_name}</span>
                                                </div>
                                                <FramedAvatar userId={match.winner_id} avatarUrl={match.winner_avatar} sizeClassName="h-12 w-12 border-2 border-primary" />
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 max-w-3xl mx-auto">
                        <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-6">
                            <h2 className="text-3xl font-black italic tracking-tighter flex items-center gap-4">
                                ...
                                {t('rivalry_page.match_history_for', { username: player1?.username || player2?.username })}
                            </h2>
