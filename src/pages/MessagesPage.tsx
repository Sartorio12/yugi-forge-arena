  ...
  return (
    <div className="h-screen bg-background text-white flex flex-col">
      ...
      <main className="flex-1 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 h-[calc(100vh-81px)]">
        ...
        <div className="md:col-span-1 lg:col-span-1 border-r border-border h-full overflow-hidden min-w-0">
          <ConversationList 
        ...
        <div className="md:col-span-2 lg:col-span-3 h-full overflow-hidden min-w-0">
          <ChatWindow 
            selectedUserId={selectedUserId}
            currentUser={user} 
          />
