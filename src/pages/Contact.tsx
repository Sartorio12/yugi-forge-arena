  ...
  return (
    <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center text-center min-h-[calc(100vh-200px)]">
      ...
      <p className="text-xl text-muted-foreground max-w-2xl mb-8">
        Tem alguma dúvida, sugestão ou precisa de suporte? Nossa equipe está pronta para ajudar. Clique no botão abaixo para falar conosco diretamente no WhatsApp.
      </p>
      <a
        href={whatsappUrl}
        target="_blank"
